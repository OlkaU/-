...
#include "library2\SvetlanaLib.h"
...
void Other ()
    ...
    while (t <= 100)
        ...
        DrawMalchikIVAN (50 + t*5, 500, 1.7, 1.7, 2.5, t%2 * 2,  t%2 + 1,  3);
        DrawDevohkaLIZA ( 0 + t*5, 550, 1.7, 1.7,  10, 10, (t%7 + 5) * 2 , (t%9 + 5) * 2, 0.5, 0.25, 0.5);

        DrawCot    (450, 250, 0.3, 0.3, TX_BLACK, 0, 0, 0, 0, 0, t%2, t%2, 0, 0);
...
void Rearwards()
    ...
    while (t <= 100)
        ...
        DrawMalchikIVAN (550, 500 - t*3, 1.7, 1.7, t%2 * 2,  0,  2,  3);
        DrawDevohkaLIZA (500, 550 - t*3, 1.7, 1.7,  10, 10, (t%7 + 5) * 2, (t%9 + 5) * 2, 0.5, 0.25, 0.5);

        DrawCot    (450, 250, 0.3, 0.3, TX_BLACK, 0, 0, 0, 0, 0, 0, 0, 1 + t%3, 1 + t%2);
        DrawRaketa (700, 200,   2,   2);
...
void Torocket()
    ...
    while (t <= 100)
        ...
        DrawMalchikIVAN (550 + t*1.5, 200, 1.7, 1.7, 2.5,  0,  t%2 + 1,  3);
...
void Flight()
    ...
    while (t <= 200)
        ...
        DrawDevohkaLIZA (500, 250, 1.7, 1.7, 10 - t%2*20, 10, 10, 10, 0.5, 0.25, 0.5);

        DrawCot    (450, 250,      0.3, 0.3, TX_BLACK,1, t%2 - 0.25, 0, 0, 0, 0, 0, 0, 0);
...
void One()
    ...
    while (t <= 110)
        ...
        DrawDevohkaLIZA (500 - t*5, 250, 1.7, 1.7, 10, 10, (t%7 + 5) * 2, (t%9 + 5) * 2, 0.5, 0.25, 0.5);

        DrawCot    (450 - t*5, 250,      0.3, 0.3, TX_BLACK,1, t%2 - 0.25, 0, t%4 + 2, t%4 - 2, 0, 0, 0, 0);
